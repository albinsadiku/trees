...
<h1 class="lg:text-5xl  w-full my-2 text-2xl font-bold leading-tight text-center text-green-600">Karakteristikat rreth pyjeve të Kosovës </h1>
				...
				<div class="flex flex-col sm:flex-row justify-center pt-12 my-12 sm:my-4">
					...
					<div class="flex flex-col w-5/6 lg:w-1/4 mx-auto lg:mx-0 rounded-none lg:rounded-l-lg bg-white mt-4">
						...
						<div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
							<div class="w-full pt-6 text-3xl text-gray-600 font-bold text-center"> <span class="text-base">Për një person</span></div>
					...
					<div class="flex flex-col w-5/6 lg:w-1/3 mx-auto lg:mx-0 rounded-lg bg-white mt-4 sm:-mt-6 shadow-lg z-10">
						...
						<div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
							<div class="w-full pt-6 text-4xl font-bold text-center"><?php the_sub_field('qmimi_2'); ?>€<span class="text-base">/ për person</span></div>
							<div class="flex items-center justify-center">
					...
					<div class="flex flex-col w-5/6 lg:w-1/4 mx-auto lg:mx-0 rounded-none lg:rounded-l-lg bg-white mt-4">
						...
						<div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
							<div class="w-full pt-6 text-3xl text-gray-600 font-bold text-center"><?php the_sub_field('qmimi'); ?>€ <span class="text-base">/ për person</span></div>
							<div class="flex items-center justify-center">
