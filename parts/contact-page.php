...
<body class="bg-gray-800 text-gray-100 px-8 py-12 mb-2">
      ...
      <div
        ...
        <div class="flex flex-col justify-between">
          <div>
            <h2 class="text-4xl lg:text-5xl font-bold leading-tight">Le te flasim per gjithqka</h2>
        ...
        <?php echo do_shortcode('[contact-form-7 id="305" title="Contact form 1"]'); ?>
